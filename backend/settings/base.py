"""
Django settings for cnext_search project.
...
SECRET_KEY = config.get("SECRET_KEY", "this_is_a_default_secret_key_for_cnext")
...
PROJECT_APPS = ["dashboard", "mainsite", "utils"]
...
SESSION_DOMAIN_NAME = config.get("SESSION_DOMAIN_NAME", ".careers360.com")
...
AWS_DISTRIBUTION_ID = config.get("AWS_DISTRIBUTION_ID", "")
S3_BUCKET = config.get("S3_BUCKET", "")
S3_FOLDER_NAME = config.get("S3_FOLDER_NAME", "")
SES_REGION_NAME = config.get("SES_REGION_NAME", "")
S3_REGION_NAME = config.get("S3_REGION_NAME", "")
S3_EXPIRE_TIME = 86400  # 1 Day
